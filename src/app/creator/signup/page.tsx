    ...
    <div className="flex-1 flex flex-col justify-center py-12 px-6 lg:px-8 bg-slate-50 min-h-screen">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-slate-600">
          Or{" "}
          <Link href="/creator/login" className="font-medium text-luxury-blue-600 hover:text-luxury-blue-500">
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 border border-slate-100 rounded-xl shadow-sm sm:px-10">
          ...
          <div className="mt-6 border-t border-slate-100 pt-6 text-center">
            <div className="inline-flex items-center gap-1.5 text-xs text-luxury-purple-600 font-semibold bg-luxury-purple-50 px-2.5 py-1 rounded-full mb-6">
              <Sparkles className="w-3 h-3" />
              <span>Includes instant Audience Trust index check</span>
            </div>
            ...
            <div className="relative mb-6">
              ...
              <div className="relative flex justify-center text-[10px] uppercase tracking-wider font-semibold">
                <span className="bg-white px-2 text-slate-400">Or Register With SSO</span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                <svg className="w-4 h-4 text-pink-650" viewBox="0 0 24 24" fill="currentColor">
